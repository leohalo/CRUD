...
app.post('/api/articulos', (req,res)=>{
    let data = {producto:req.body.producto, precio:req.body.precio, stock:req.body.stock}
...
app.put('/api/articulos/:id', (req, res)=>{
    ...
    let sql = "UPDATE articulos SET producto = ?, precio = ?, stock = ? WHERE id = ?"
    conexion.query(sql, [prducto, precio, stock, id], function(error, results){
        if(error){
            throw error
        }else{              
            res.send(results)
